...
import { getAllPosts, getPostBySlug } from "@/app/lib/contentful"
...
export default async function Blog() {
  try {
    // Try fetching a specific post first
    console.log('Debug - Attempting to fetch specific post')
    const testPost = await getPostBySlug('hidden-gems-in-excel')
    console.log('Debug - Test post result:', testPost ? 'Found' : 'Not found')

    // If that works, try fetching all posts
    console.log('Debug - Attempting to fetch all posts')
    const posts = await getAllPosts()
    console.log('Debug - All posts count:', posts.length)
    ...
    console.error('Debug - Error in Blog page:', error)
    throw error
  }
}
